...
import { isSecretRef } from "ultraclaw/plugin-sdk/googlechat";
import { createAccountListHelpers, type UltraClawConfig } from "ultraclaw/plugin-sdk/googlechat";
...
export function listEnabledGoogleChatAccounts(cfg: UltraClawConfig): ResolvedGoogleChatAccount[] {
