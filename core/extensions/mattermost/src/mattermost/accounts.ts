...
import { createAccountListHelpers, type UltraClawConfig } from "ultraclaw/plugin-sdk/mattermost";
...
export function listEnabledMattermostAccounts(cfg: UltraClawConfig): ResolvedMattermostAccount[] {
