import type { UltraClawConfig, PluginRuntime, ReplyPayload } from "ultraclaw/plugin-sdk/mattermost";
import { getAgentScopedMediaLocalRoots } from "ultraclaw/plugin-sdk/mattermost";
