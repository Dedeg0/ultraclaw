...
import type { UltraClawPluginApi } from "ultraclaw/plugin-sdk/mattermost";
...
export function activateSlashCommands(params: {
  ...
  triggerMap?: Map<string, string>;
  api: {
    cfg: import("ultraclaw/plugin-sdk/mattermost").UltraClawConfig;
    runtime: import("ultraclaw/plugin-sdk/mattermost").RuntimeEnv;
  };
  log?: (msg: string) => void;
}) {
 ...
 */
export function registerSlashCommandRoute(api: UltraClawPluginApi) {
