import type { UltraClawConfig, UltraClawPluginApi } from "ultraclaw/plugin-sdk/thread-ownership";
...
function resolveOwnershipAgent(config: UltraClawConfig): { id: string; name: string } {
