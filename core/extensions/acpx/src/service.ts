import type {
  ...
  PluginLogger,
} from "ultraclaw/plugin-sdk/acpx";
import { registerAcpRuntimeBackend, unregisterAcpRuntimeBackend } from "ultraclaw/plugin-sdk/acpx";
...
export function createAcpxRuntimeService(
  ...
  return {
    id: "acpx-runtime",
    async start(ctx: UltraClawPluginServiceContext): Promise<void> {
    ...
    async stop(_ctx: UltraClawPluginServiceContext): Promise<void> {
      lifecycleRevision += 1;
