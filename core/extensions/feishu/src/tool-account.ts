...
import type { UltraClawPluginApi } from "ultraclaw/plugin-sdk/feishu";
...
function readConfiguredDefaultAccountId(config: UltraClawPluginApi["config"]): string | undefined {
...
export function resolveFeishuToolAccount(params: {
  api: Pick<UltraClawPluginApi, "config">;
