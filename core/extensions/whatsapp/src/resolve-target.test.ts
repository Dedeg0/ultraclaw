...
vi.mock("ultraclaw/plugin-sdk/whatsapp", async () => {
  const actual = await vi.importActual<typeof import("ultraclaw/plugin-sdk/whatsapp")>(
    "ultraclaw/plugin-sdk/whatsapp",
  );
