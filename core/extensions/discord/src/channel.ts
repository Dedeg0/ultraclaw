import { createScopedChannelConfigBase } from "ultraclaw/plugin-sdk/compat";
import {
...
} from "ultraclaw/plugin-sdk/discord";
...
export const discordPlugin: ChannelPlugin<ResolvedDiscordAccount> = {
  ...
  agentPrompt: {
    messageToolHints: () => [
      ...
      "- Forms: add `components.modal` (title, fields). UltraClaw adds a trigger button and routes submissions as new messages.",
    ],
  },
  messaging: {
