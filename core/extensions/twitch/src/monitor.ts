...
import type { ReplyPayload, UltraClawConfig } from "ultraclaw/plugin-sdk/twitch";
import { createReplyPrefixOptions } from "ultraclaw/plugin-sdk/twitch";
...
export type TwitchMonitorOptions = {
  ...
  accountId: string;
  config: unknown; // UltraClawConfig
...
async function processTwitchMessage(params: {
  ...
  const cfg = config as UltraClawConfig;
