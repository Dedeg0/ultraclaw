...
} from "ultraclaw/plugin-sdk/zalouser";
import {
...
function resolveZalouserOutboundChunkMode(cfg: UltraClawConfig, accountId?: string) {
  return getZalouserRuntime().channel.text.resolveChunkMode(cfg, "zalouser", accountId);
}

function resolveZalouserOutboundTextChunkLimit(cfg: UltraClawConfig, accountId?: string) {
