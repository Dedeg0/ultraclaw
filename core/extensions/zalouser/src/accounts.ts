...
import { createAccountListHelpers, type UltraClawConfig } from "ultraclaw/plugin-sdk/zalouser";
...
function mergeZalouserAccountConfig(cfg: UltraClawConfig, accountId: string): ZalouserAccountConfig {
