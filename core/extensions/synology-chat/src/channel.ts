/**
 * Synology Chat Channel Plugin for UltraClaw.
 *
...
} from "ultraclaw/plugin-sdk/synology-chat";
import { z } from "zod";
...
export function createSynologyChatPlugin() {
  return {
    ...
    meta: {
      ...
      blurb: "Connect your Synology NAS Chat to UltraClaw",
      order: 90,
    },
    ...
    pairing: {
      ...
      notifyApproval: async ({ cfg, id }: { cfg: any; id: string }) => {
        ...
        await sendMessage(
          account.incomingUrl,
          "UltraClaw: your access has been approved.",
          id,
    ...
    security: {
      resolveDmPolicy: ({
        ...
        return {
          ...
          approveHint: "ultraclaw pairing approve synology-chat <code>",
