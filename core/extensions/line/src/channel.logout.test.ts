import type { UltraClawConfig, PluginRuntime, ResolvedLineAccount } from "ultraclaw/plugin-sdk/line";
...
async function runLogoutScenario(params: { cfg: UltraClawConfig; accountId: string }): Promise<{
