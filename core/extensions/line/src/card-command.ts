import type { LineChannelData, UltraClawPluginApi, ReplyPayload } from "ultraclaw/plugin-sdk/line";
import {
  createActionCard,
  createImageCard,
  createInfoCard,
...
export function registerLineCardCommand(api: UltraClawPluginApi): void {
  api.registerCommand({
    name: "card",
