import { DEFAULT_ACCOUNT_ID, normalizeAccountId } from "ultraclaw/plugin-sdk/account-id";
import { createAccountListHelpers, type UltraClawConfig } from "ultraclaw/plugin-sdk/zalo";
...
function mergeZaloAccountConfig(cfg: UltraClawConfig, accountId: string): ZaloAccountConfig {
...
export function listEnabledZaloAccounts(cfg: UltraClawConfig): ResolvedZaloAccount[] {
