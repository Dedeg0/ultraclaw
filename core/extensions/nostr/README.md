...
Nostr DM channel plugin for UltraClaw using NIP-04 encrypted direct messages.

## Overview

This extension adds Nostr as a messaging channel to UltraClaw. It enables your bot to:
...
# Configure ultraclaw to use local relay
