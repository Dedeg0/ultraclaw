...
} from "ultraclaw/plugin-sdk/account-id";
import type { UltraClawConfig } from "ultraclaw/plugin-sdk/nostr";
...
function resolveConfiguredDefaultNostrAccountId(cfg: UltraClawConfig): string | undefined {
 ...
 */
export function listNostrAccountIds(cfg: UltraClawConfig): string[] {
  const nostrCfg = (cfg.channels as Record<string, unknown> | undefined)?.nostr as
    | NostrAccountConfig
    | undefined;
 ...
 */
export function resolveDefaultNostrAccountId(cfg: UltraClawConfig): string {
