...
import type { UltraClawPluginApi } from "ultraclaw/plugin-sdk/diffs";
...
describe("diffs tool", () => {
  ...
  beforeEach(async () => {
    ({ store, cleanup: cleanupRootDir } = await createDiffStoreHarness("ultraclaw-diffs-tool-"));
  });
...
function createApi(): UltraClawPluginApi {
  return {
    id: "diffs",
    name: "Diffs",
    description: "Diffs",
    ...
    runtime: {} as UltraClawPluginApi["runtime"],
    logger: {
      info() {},
      warn() {},
      error() {},
