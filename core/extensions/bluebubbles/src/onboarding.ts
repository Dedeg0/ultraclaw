import type {
  ...
  DmPolicy,
  WizardPrompter,
} from "ultraclaw/plugin-sdk/bluebubbles";
import {
  DEFAULT_ACCOUNT_ID,
  formatDocsLink,
...
function setBlueBubblesDmPolicy(cfg: UltraClawConfig, dmPolicy: DmPolicy): UltraClawConfig {
  ...
  configure: async ({ cfg, prompter, accountOverrides, shouldPromptAccountIds }) => {
    ...
    await prompter.note(
      [
        ...
        "2. Add your UltraClaw gateway URL + webhook path",
