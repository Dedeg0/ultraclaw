...
import { createAccountListHelpers, type UltraClawConfig } from "ultraclaw/plugin-sdk/bluebubbles";
...
export function listEnabledBlueBubblesAccounts(cfg: UltraClawConfig): ResolvedBlueBubblesAccount[] {
