...
import { resolveChannelMediaMaxBytes, type UltraClawConfig } from "ultraclaw/plugin-sdk/bluebubbles";
...
function resolveMediaLocalRoots(params: { cfg: UltraClawConfig; accountId?: string }): string[] {
