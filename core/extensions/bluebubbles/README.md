...
This directory contains the **BlueBubbles external channel plugin** for UltraClaw.
...
- Route into core reply pipeline via the plugin runtime (`api.runtime`) and `ultraclaw/plugin-sdk` helpers.
