...
import { SILENT_REPLY_TOKEN, type PluginRuntime } from "ultraclaw/plugin-sdk/msteams";
...
import { resolvePreferredUltraClawTmpDir } from "../../../src/infra/tmp-ultraclaw-dir.js";
import {
  type MSTeamsAdapter,
...
describe("msteams messenger", () => {
  ...
  describe("sendMSTeamsMessages", () => {
    ...
    it("preserves parsed mentions when appending OneDrive fallback file links", async () => {
      const tmpDir = await mkdtemp(path.join(resolvePreferredUltraClawTmpDir(), "msteams-mention-"));
