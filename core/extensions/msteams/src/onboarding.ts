import type {
  ...
  WizardPrompter,
  MSTeamsTeamConfig,
} from "ultraclaw/plugin-sdk/msteams";
import {
  DEFAULT_ACCOUNT_ID,
  formatDocsLink,
...
function setMSTeamsDmPolicy(cfg: UltraClawConfig, dmPolicy: DmPolicy) {
...
function setMSTeamsAllowFrom(cfg: UltraClawConfig, allowFrom: string[]): UltraClawConfig {
