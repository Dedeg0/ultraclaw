...
import type { UltraClawConfig, RuntimeEnv } from "ultraclaw/plugin-sdk/msteams";
...
vi.mock("ultraclaw/plugin-sdk/msteams", () => ({
...
function createConfig(port: number): UltraClawConfig {
  return {
    channels: {
      msteams: {
        enabled: true,
