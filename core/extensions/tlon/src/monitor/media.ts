...
import { fetchWithSsrFGuard } from "ultraclaw/plugin-sdk/tlon";
import { getDefaultSsrFPolicy } from "../urbit/context.js";

// Default to UltraClaw workspace media directory
const DEFAULT_MEDIA_DIR = path.join(homedir(), ".ultraclaw", "workspace", "media", "inbound");
 ...
 * Format matches UltraClaw's expected attachment structure.
 */
