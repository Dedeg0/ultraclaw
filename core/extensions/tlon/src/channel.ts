...
import type {
  ...
  ChannelSetupInput,
  UltraClawConfig,
} from "ultraclaw/plugin-sdk/tlon";
import {
...
export const tlonPlugin: ChannelPlugin = {
  ...
  status: {
    ...
    buildAccountSnapshot: ({ account, runtime, probe }) => {
      ...
      return snapshot as import("ultraclaw/plugin-sdk/tlon").ChannelAccountSnapshot;
    },
  },
  gateway: {
    startAccount: async (ctx) => {
      ...
      ctx.setStatus({
        ...
        ship: account.ship,
        url: account.url,
      } as import("ultraclaw/plugin-sdk/tlon").ChannelAccountSnapshot);
