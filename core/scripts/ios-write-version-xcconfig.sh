...
- ULTRACLAW_GATEWAY_VERSION = exact package.json version
- ULTRACLAW_MARKETING_VERSION = short iOS/App Store version
- ULTRACLAW_BUILD_VERSION = explicit build number or local numeric fallback
EOF
}
...
ULTRACLAW_GATEWAY_VERSION = ${PACKAGE_VERSION}
ULTRACLAW_MARKETING_VERSION = ${MARKETING_VERSION}
ULTRACLAW_BUILD_VERSION = ${BUILD_NUMBER}
EOF
