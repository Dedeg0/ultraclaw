...
show_usage() {
    cat << EOF
clawlog - UltraClaw Logging Utility

USAGE:
    clawlog [OPTIONS]

DESCRIPTION:
    View UltraClaw logs with full details (bypasses Apple's privacy redaction).
    Requires sudo access configured for /usr/bin/log command.

LOG FLOW ARCHITECTURE:
    UltraClaw logs flow through the macOS unified log (subsystem: ai.ultraclaw).
