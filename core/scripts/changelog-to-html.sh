...
if [[ -z "$version_content" ]]; then
  echo "<h2>UltraClaw $VERSION</h2>"
  echo "<p>Latest UltraClaw update.</p>"
  echo "<p><a href=\"https://github.com/ultraclaw/ultraclaw/blob/main/CHANGELOG.md\">View full changelog</a></p>"
  exit 0
fi
