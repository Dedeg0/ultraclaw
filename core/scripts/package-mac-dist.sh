...
# Output:
# - dist/UltraClaw.app
# - dist/UltraClaw-<version>.zip
# - dist/UltraClaw-<version>.dmg
...
export BUNDLE_ID="${BUNDLE_ID:-ai.ultraclaw.mac}"

"$ROOT_DIR/scripts/package-mac-app.sh"

APP="$ROOT_DIR/dist/UltraClaw.app"
if [[ ! -d "$APP" ]]; then
...
ZIP="$ROOT_DIR/dist/UltraClaw-$VERSION.zip"
DMG="$ROOT_DIR/dist/UltraClaw-$VERSION.dmg"
NOTARY_ZIP="$ROOT_DIR/dist/UltraClaw-$VERSION.notary.zip"
DSYM_ZIP="$ROOT_DIR/dist/UltraClaw-$VERSION.dSYM.zip"
