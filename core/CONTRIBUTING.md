...
- **GitHub:** https://github.com/ultraclaw/ultraclaw
- **Vision:** [`VISION.md`](VISION.md)
- **Discord:** https://discord.gg/qkhbAGHRBT
- **X/Twitter:** [@steipete](https://x.com/steipete) / [@ultraclaw](https://x.com/ultraclaw)
...
2. **New features / architecture** → Start a [GitHub Discussion](https://github.com/ultraclaw/ultraclaw/discussions) or ask in Discord first
...
- Test locally with your UltraClaw instance
...
- **Skills**: For skill contributions, head to [ClawHub](https://clawhub.ai/) — the community hub for UltraClaw skills.
- **Performance**: Optimizing token usage and compaction logic.

Check the [GitHub Issues](https://github.com/ultraclaw/ultraclaw/issues) for "good first issue" labels!

## Maintainers

We're selectively expanding the maintainer team.
If you're an experienced contributor who wants to help shape UltraClaw's direction — whether through code, docs, or community — we'd like to hear from you.

Being a maintainer is a responsibility, not an honorary title. We expect active, consistent involvement — triaging issues, reviewing PRs, and helping move the project forward.

Still interested? Email contributing@ultraclaw.os with:

- Links to your PRs on UltraClaw (if you don't have any, start there first)
...
For issues that don't fit a specific repo, or if you're unsure, email **security@ultraclaw.os** and we'll route it.
