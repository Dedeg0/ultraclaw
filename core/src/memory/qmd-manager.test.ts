...
describe("QmdMemoryManager", () => {
  ...
  let stateDir: string;
  let cfg: UltraClawConfig;
  const agentId = "main";

  async function createManager(params?: { mode?: "full" | "status"; cfg?: UltraClawConfig }) {
  ...
  afterEach(() => {
    ...
    delete (globalThis as Record<string, unknown>).__ultraclawMcporterDaemonStart;
    delete (globalThis as Record<string, unknown>).__ultraclawMcporterColdStartWarned;
  });
