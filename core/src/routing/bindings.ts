...
export function listBindings(cfg: UltraClawConfig): AgentRouteBinding[] {
...
export function listBoundAccountIds(cfg: UltraClawConfig, channelId: string): string[] {
...
export function buildChannelAccountBindings(cfg: UltraClawConfig) {
