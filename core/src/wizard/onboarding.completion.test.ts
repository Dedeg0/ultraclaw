...
describe("setupOnboardingShellCompletion", () => {
  it("QuickStart: installs without prompting", async () => {
    ...
    expect(deps.ensureCompletionCacheExists).toHaveBeenCalledWith("ultraclaw");
    expect(deps.installCompletion).toHaveBeenCalledWith("zsh", true, "ultraclaw");
