...
export function listWhatsAppAuthDirs(cfg: UltraClawConfig): string[] {
...
export function hasAnyWhatsAppAuth(cfg: UltraClawConfig): boolean {
...
export function resolveWhatsAppAuthDir(params: { cfg: UltraClawConfig; accountId: string }): {
  authDir: string;
  isLegacy: boolean;
} {
...
export function listEnabledWhatsAppAccounts(cfg: UltraClawConfig): ResolvedWhatsAppAccount[] {
