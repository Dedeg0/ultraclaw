...
export const normalizePluginsConfig = (
  config?: UltraClawConfig["plugins"],
...
const hasExplicitMemorySlot = (plugins?: UltraClawConfig["plugins"]) =>
  Boolean(plugins?.slots && Object.prototype.hasOwnProperty.call(plugins.slots, "memory"));

const hasExplicitMemoryEntry = (plugins?: UltraClawConfig["plugins"]) =>
  Boolean(plugins?.entries && Object.prototype.hasOwnProperty.call(plugins.entries, "memory-core"));

const hasExplicitPluginConfig = (plugins?: UltraClawConfig["plugins"]) => {
  if (!plugins) {
    return false;
  }
