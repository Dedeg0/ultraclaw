...
export const PLUGIN_MANIFEST_FILENAME = "ultraclaw.plugin.json";
...
// package.json "ultraclaw" metadata (used for onboarding/catalog)
...
export type UltraClawPackageManifest = {
  extensions?: string[];
...
): UltraClawPackageManifest | undefined {
  if (!manifest) {
    return undefined;
  }
