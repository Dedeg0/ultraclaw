...
import type {
  UltraClawPluginApi,
  UltraClawPluginChannelRegistration,
  UltraClawPluginCliRegistrar,
  UltraClawPluginCommandDefinition,
  UltraClawPluginHttpRouteAuth,
  UltraClawPluginHttpRouteMatch,
  UltraClawPluginHttpRouteHandler,
  UltraClawPluginHttpRouteParams,
  UltraClawPluginHookOptions,
  ProviderPlugin,
  UltraClawPluginService,
  UltraClawPluginToolContext,
...
export type PluginToolRegistration = {
  pluginId: string;
  factory: UltraClawPluginToolFactory;
  names: string[];
  optional: boolean;
  source: string;
};
...
export type PluginCliRegistration = {
  pluginId: string;
  register: UltraClawPluginCliRegistrar;
  commands: string[];
  source: string;
};
...
export type PluginServiceRegistration = {
  pluginId: string;
  service: UltraClawPluginService;
  source: string;
};

export type PluginCommandRegistration = {
  pluginId: string;
  command: UltraClawPluginCommandDefinition;
  source: string;
};
...
export function createPluginRegistry(registryParams: PluginRegistryParams) {
  ...
  const registerTool = (
    ...
    const factory: UltraClawPluginToolFactory =
      typeof tool === "function" ? tool : (_ctx: UltraClawPluginToolContext) => tool;
  ...
  const registerHook = (
    ...
    opts: UltraClawPluginHookOptions | undefined,
    config: UltraClawPluginApi["config"],
  ) => {
  ...
  const registerHttpRoute = (record: PluginRecord, params: UltraClawPluginHttpRouteParams) => {
  ...
  const registerChannel = (
    record: PluginRecord,
    registration: UltraClawPluginChannelRegistration | ChannelPlugin,
  ) => {
    const normalized =
      typeof (registration as UltraClawPluginChannelRegistration).plugin === "object"
        ? (registration as UltraClawPluginChannelRegistration)
  ...
  const registerCli = (
    record: PluginRecord,
    registrar: UltraClawPluginCliRegistrar,
  ...
  const registerService = (record: PluginRecord, service: UltraClawPluginService) => {
  ...
  const registerCommand = (record: PluginRecord, command: UltraClawPluginCommandDefinition) => {
