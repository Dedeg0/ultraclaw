...
export type UltraClawPluginConfigSchema = {
...
export type UltraClawPluginToolContext = {
...
export type UltraClawPluginToolFactory = (
  ctx: UltraClawPluginToolContext,
) => AnyAgentTool | AnyAgentTool[] | null | undefined;

export type UltraClawPluginToolOptions = {
  name?: string;
  names?: string[];
  optional?: boolean;
};

export type UltraClawPluginHookOptions = {
  entry?: HookEntry;
  name?: string;
  description?: string;
  register?: boolean;
...
export type ProviderAuthResult = {
  ...
  configPatch?: Partial<UltraClawConfig>;
  defaultModel?: string;
  notes?: string[];
};
...
export type UltraClawPluginGatewayMethod = {
  method: string;
...
export type PluginCommandContext = {
  ...
  commandBody: string;
  /** Current UltraClaw configuration */
  config: UltraClawConfig;
 ...
 */
export type UltraClawPluginCommandDefinition = {
...
export type UltraClawPluginHttpRouteAuth = "gateway" | "plugin";
export type UltraClawPluginHttpRouteMatch = "exact" | "prefix";

export type UltraClawPluginHttpRouteHandler = (
  req: IncomingMessage,
  res: ServerResponse,
) => Promise<boolean | void> | boolean | void;

export type UltraClawPluginHttpRouteParams = {
  path: string;
  handler: UltraClawPluginHttpRouteHandler;
  auth: UltraClawPluginHttpRouteAuth;
  match?: UltraClawPluginHttpRouteMatch;
  replaceExisting?: boolean;
};

export type UltraClawPluginCliContext = {
  program: Command;
  config: UltraClawConfig;
  workspaceDir?: string;
  logger: PluginLogger;
...
export type UltraClawPluginCliRegistrar = (ctx: UltraClawPluginCliContext) => void | Promise<void>;

export type UltraClawPluginServiceContext = {
  config: UltraClawConfig;
  workspaceDir?: string;
  stateDir: string;
  logger: PluginLogger;
...
export type UltraClawPluginService = {
  id: string;
  start: (ctx: UltraClawPluginServiceContext) => void | Promise<void>;
  stop?: (ctx: UltraClawPluginServiceContext) => void | Promise<void>;
};

export type UltraClawPluginChannelRegistration = {
  plugin: ChannelPlugin;
  dock?: ChannelDock;
};

export type UltraClawPluginDefinition = {
  id?: string;
  name?: string;
  description?: string;
  version?: string;
  kind?: PluginKind;
  configSchema?: UltraClawPluginConfigSchema;
  register?: (api: UltraClawPluginApi) => void | Promise<void>;
  activate?: (api: UltraClawPluginApi) => void | Promise<void>;
};

export type UltraClawPluginModule =
  | UltraClawPluginDefinition
  | ((api: UltraClawPluginApi) => void | Promise<void>);

export type UltraClawPluginApi = {
  id: string;
  name: string;
  version?: string;
  description?: string;
  ...
  logger: PluginLogger;
  registerTool: (
    tool: AnyAgentTool | UltraClawPluginToolFactory,
    opts?: UltraClawPluginToolOptions,
  ) => void;
  registerHook: (
    events: string | string[],
    handler: InternalHookHandler,
    opts?: UltraClawPluginHookOptions,
  ) => void;
  registerHttpRoute: (params: UltraClawPluginHttpRouteParams) => void;
  registerChannel: (registration: UltraClawPluginChannelRegistration | ChannelPlugin) => void;
  registerGatewayMethod: (method: string, handler: GatewayRequestHandler) => void;
  registerCli: (registrar: UltraClawPluginCliRegistrar, opts?: { commands?: string[] }) => void;
  registerService: (service: UltraClawPluginService) => void;
   ...
   */
  registerCommand: (command: UltraClawPluginCommandDefinition) => void;
