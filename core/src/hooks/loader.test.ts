...
describe("loader", () => {
  ...
  beforeAll(async () => {
    fixtureRoot = await fs.mkdtemp(path.join(os.tmpdir(), "ultraclaw-hooks-loader-"));
  });
  ...
  beforeEach(async () => {
    ...
    envSnapshot = captureEnv(["ULTRACLAW_BUNDLED_HOOKS_DIR"]);
    process.env.ULTRACLAW_BUNDLED_HOOKS_DIR = "/nonexistent/bundled/hooks";
  ...
  describe("loadInternalHooks", () => {
    ...
    const expectNoCommandHookRegistration = async (cfg: UltraClawConfig) => {
