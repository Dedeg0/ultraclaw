/**
 * Hook system for UltraClaw agent events
 *
...
const _g = globalThis as typeof globalThis & {
  __ultraclaw_internal_hook_handlers__?: Map<string, InternalHookHandler[]>;
};
const handlers = (_g.__ultraclaw_internal_hook_handlers__ ??= new Map<
  string,
  InternalHookHandler[]
>());
