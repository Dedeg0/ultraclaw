...
export function listAuthProfileStorePaths(config: UltraClawConfig, stateDir: string): string[] {
...
export function collectAuthStorePaths(config: UltraClawConfig, stateDir: string): string[] {
