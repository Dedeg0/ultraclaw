...
async function runRuntimeWebTools(params: { config: UltraClawConfig; env?: NodeJS.ProcessEnv }) {
...
function readProviderKey(config: UltraClawConfig, provider: ProviderUnderTest): unknown {
  if (provider === "brave") {
