...
function resolveResolutionLimits(config: UltraClawConfig): ResolutionLimits {
...
function resolveConfiguredProvider(ref: SecretRef, config: UltraClawConfig): SecretProviderConfig {
