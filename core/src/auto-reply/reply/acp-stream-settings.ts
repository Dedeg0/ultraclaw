...
function resolveAcpStreamCoalesceIdleMs(cfg: UltraClawConfig): number {
...
function resolveAcpStreamMaxChunkChars(cfg: UltraClawConfig): number {
...
export function resolveAcpProjectionSettings(cfg: UltraClawConfig): AcpProjectionSettings {
