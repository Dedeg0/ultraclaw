...
function resolveMentionPatterns(cfg: UltraClawConfig | undefined, agentId?: string): string[] {
  if (!cfg) {
    return [];
  }
...
export function buildMentionRegexes(cfg: UltraClawConfig | undefined, agentId?: string): RegExp[] {
