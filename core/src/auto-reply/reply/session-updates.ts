...
export async function drainFormattedSystemEvents(params: {
  ...
  const resolveSystemEventTimezone = (cfg: UltraClawConfig) => {
  ...
  const formatSystemEventTimestamp = (ts: number, cfg: UltraClawConfig) => {
...
export async function ensureSkillSnapshot(params: {
  ...
  if (process.env.ULTRACLAW_TEST_FAST === "1") {
