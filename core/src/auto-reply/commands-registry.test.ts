...
describe("commands registry", () => {
  ...
  it("normalizes telegram-style command mentions for the current bot", () => {
    expect(normalizeCommandBody("/help@ultraclaw", { botUsername: "ultraclaw" })).toBe("/help");
    expect(
      normalizeCommandBody("/help@ultraclaw args", {
        botUsername: "ultraclaw",
      }),
    ).toBe("/help args");
    expect(
      normalizeCommandBody("/help@ultraclaw: args", {
  ...
  it("keeps telegram-style command mentions for other bots", () => {
    expect(normalizeCommandBody("/help@otherbot", { botUsername: "ultraclaw" })).toBe(
      "/help@otherbot",
    );
  });
