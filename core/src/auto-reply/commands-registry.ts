...
export function isCommandEnabled(cfg: UltraClawConfig, commandKey: string): boolean {
...
function resolveDefaultCommandContext(cfg?: UltraClawConfig): {
  provider: string;
  model: string;
} {
  const resolved = resolveConfiguredModelRef({
    cfg: cfg ?? ({} as UltraClawConfig),
...
export function getCommandDetection(_cfg?: UltraClawConfig): CommandDetection {
  const commands = getChatCommands();
...
export function maybeResolveTextAlias(raw: string, cfg?: UltraClawConfig) {
