...
describe("modelsAuthLoginCommand", () => {
  ...
  let currentConfig: UltraClawConfig;
  let lastUpdatedConfig: UltraClawConfig | null;
  ...
  beforeEach(() => {
    ...
    mocks.resolveAgentDir.mockReturnValue("/tmp/ultraclaw/agents/main");
    mocks.resolveAgentWorkspaceDir.mockReturnValue("/tmp/ultraclaw/workspace");
    mocks.resolveDefaultAgentWorkspaceDir.mockReturnValue("/tmp/ultraclaw/workspace");
    mocks.loadValidConfigOrThrow.mockImplementation(async () => currentConfig);
    mocks.updateConfig.mockImplementation(
      async (mutator: (cfg: UltraClawConfig) => UltraClawConfig) => {
