...
function resolveDefaultAccountId(cfg: UltraClawConfig, provider: ChannelId): string {
...
function shouldShowProviderEntry(entry: ProviderAccountStatus, cfg: UltraClawConfig): boolean {
...
export function summarizeBindings(cfg: UltraClawConfig, bindings: AgentBinding[]): string[] {
