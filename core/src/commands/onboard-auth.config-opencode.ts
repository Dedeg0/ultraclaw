...
export function applyOpencodeZenProviderConfig(cfg: UltraClawConfig): UltraClawConfig {
...
export function applyOpencodeZenConfig(cfg: UltraClawConfig): UltraClawConfig {
