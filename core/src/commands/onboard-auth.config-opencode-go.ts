...
export function applyOpencodeGoProviderConfig(cfg: UltraClawConfig): UltraClawConfig {
...
export function applyOpencodeGoConfig(cfg: UltraClawConfig): UltraClawConfig {
