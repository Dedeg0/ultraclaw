...
export function applyVercelAiGatewayProviderConfig(cfg: UltraClawConfig): UltraClawConfig {
...
export function applyVercelAiGatewayConfig(cfg: UltraClawConfig): UltraClawConfig {
