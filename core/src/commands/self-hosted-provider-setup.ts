...
export function applyProviderDefaultModel(cfg: UltraClawConfig, modelRef: string): UltraClawConfig {
...
function buildOpenAICompatibleSelfHostedProviderConfig(params: {
  ...
  maxTokens?: number;
}): { config: UltraClawConfig; modelId: string; modelRef: string; profileId: string } {
