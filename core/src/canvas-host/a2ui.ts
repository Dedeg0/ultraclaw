...
export const A2UI_PATH = "/__ultraclaw__/a2ui";

export const CANVAS_HOST_PATH = "/__ultraclaw__/canvas";

export const CANVAS_WS_PATH = "/__ultraclaw__/ws";
...
(() => {
  ...
  // Works on:
  // - iOS: window.webkit.messageHandlers.ultraclawCanvasA2UIAction.postMessage(...)
  // - Android: window.ultraclawCanvasA2UIAction.postMessage(...)
  const handlerNames = ["ultraclawCanvasA2UIAction"];
  ...
  globalThis.UltraClaw = globalThis.UltraClaw ?? {};
  globalThis.UltraClaw.postMessage = postToNode;
  globalThis.UltraClaw.sendUserAction = sendUserAction;
  globalThis.ultraclawPostMessage = postToNode;
  globalThis.ultraclawSendUserAction = sendUserAction;
