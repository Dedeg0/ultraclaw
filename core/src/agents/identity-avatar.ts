...
function resolveAvatarSource(cfg: UltraClawConfig, agentId: string): string | null {
...
export function resolveAgentAvatar(cfg: UltraClawConfig, agentId: string): AgentAvatarResolution {
