...
type AgentEntry = NonNullable<NonNullable<UltraClawConfig["agents"]>["list"]>[number];
...
export function listAgentEntries(cfg: UltraClawConfig): AgentEntry[] {
...
export function listAgentIds(cfg: UltraClawConfig): string[] {
...
export function resolveDefaultAgentId(cfg: UltraClawConfig): string {
  const agents = listAgentEntries(cfg);
  if (agents.length === 0) {
    return DEFAULT_AGENT_ID;
  }
...
function resolveAgentEntry(cfg: UltraClawConfig, agentId: string): AgentEntry | undefined {
...
export function resolveAgentModelPrimary(cfg: UltraClawConfig, agentId: string): string | undefined {
...
export function resolveAgentWorkspaceDir(cfg: UltraClawConfig, agentId: string) {
  const id = normalizeAgentId(agentId);
...
export function resolveAgentDir(cfg: UltraClawConfig, agentId: string) {
  const id = normalizeAgentId(agentId);
