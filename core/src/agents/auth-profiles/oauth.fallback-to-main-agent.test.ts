...
describe("resolveApiKeyForProfile fallback to main agent", () => {
  ...
  beforeEach(async () => {
    ...
    // Set environment variables so resolveUltraClawAgentDir() returns mainAgentDir
    process.env.ULTRACLAW_STATE_DIR = tmpDir;
    process.env.ULTRACLAW_AGENT_DIR = mainAgentDir;
