...
describe("handleSlackAction", () => {
  function slackConfig(overrides?: Record<string, unknown>): UltraClawConfig {
    return {
      channels: {
        slack: {
          botToken: "tok",
  ...
  async function resolveReadToken(cfg: UltraClawConfig): Promise<string | undefined> {
  ...
  async function resolveSendToken(cfg: UltraClawConfig): Promise<string | undefined> {
    sendSlackMessage.mockClear();
