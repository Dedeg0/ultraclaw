...
export function resolveSessionToolsVisibility(cfg: UltraClawConfig): SessionToolsVisibility {
...
export function resolveSandboxSessionToolsVisibility(cfg: UltraClawConfig): "spawned" | "all" {
...
export function createAgentToAgentPolicy(cfg: UltraClawConfig): AgentToAgentPolicy {
