...
function asUltraClawConfig(config: Partial<UltraClawConfig>): UltraClawConfig {
  return config as UltraClawConfig;
}

function createToolConfig() {
  return asUltraClawConfig({ agents: { list: [{ id: "main", default: true }] } });
}

function createMemoryGetToolOrThrow(config: UltraClawConfig = createToolConfig()) {
