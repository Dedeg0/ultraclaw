...
function resolveMemoryToolContext(options: { config?: UltraClawConfig; agentSessionKey?: string }) {
...
function resolveMemoryCitationsMode(cfg: UltraClawConfig): MemoryCitationsMode {
