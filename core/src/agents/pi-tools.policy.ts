...
export function resolveSubagentToolPolicy(cfg?: UltraClawConfig, depth?: number): SandboxToolPolicy {
...
function resolveExplicitProfileAlsoAllow(tools?: UltraClawConfig["tools"]): string[] | undefined {
...
function resolveImplicitProfileAlsoAllow(params: {
  globalTools?: UltraClawConfig["tools"];
