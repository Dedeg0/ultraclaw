...
describe("workspace bootstrap file caching", () => {
  ...
  beforeEach(async () => {
    workspaceDir = await makeTempWorkspace("ultraclaw-bootstrap-cache-test-");
  });
  ...
  it("caches files independently by path", async () => {
    ...
    const workspace1 = await makeTempWorkspace("ultraclaw-cache-test1-");
    const workspace2 = await makeTempWorkspace("ultraclaw-cache-test2-");
