...
function resolveWatchPaths(workspaceDir: string, config?: UltraClawConfig): string[] {
  const paths: string[] = [];
...
function resolveWatchTargets(workspaceDir: string, config?: UltraClawConfig): string[] {
...
export function ensureSkillsWatcher(params: { workspaceDir: string; config?: UltraClawConfig }) {
