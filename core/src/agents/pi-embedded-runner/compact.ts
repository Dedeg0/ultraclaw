...
function resolvePostCompactionIndexSyncMode(config?: UltraClawConfig): "off" | "async" | "await" {
...
export async function compactEmbeddedPiSessionDirect(
  ...
  await ensureUltraClawModelsJson(params.config, agentDir);
  ...
  try {
    ...
    const toolsRaw = createUltraClawCodingTools({
      exec: {
