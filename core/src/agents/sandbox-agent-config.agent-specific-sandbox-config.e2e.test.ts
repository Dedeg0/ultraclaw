...
async function resolveContext(config: UltraClawConfig, sessionKey: string, workspaceDir: string) {
...
function createWorkSetupCommandConfig(scope: "agent" | "shared"): UltraClawConfig {
  return {
    agents: {
      defaults: {
        sandbox: {
