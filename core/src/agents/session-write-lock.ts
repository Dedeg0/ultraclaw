...
const CLEANUP_STATE_KEY = Symbol.for("ultraclaw.sessionWriteLockCleanupState");
const HELD_LOCKS_KEY = Symbol.for("ultraclaw.sessionWriteLockHeldLocks");
const WATCHDOG_STATE_KEY = Symbol.for("ultraclaw.sessionWriteLockWatchdogState");
