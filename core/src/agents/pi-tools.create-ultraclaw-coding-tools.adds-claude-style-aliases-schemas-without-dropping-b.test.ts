...
const defaultTools = createUltraClawCodingTools({ senderIsOwner: true });
...
describe("createUltraClawCodingTools", () => {
  ...
  it("enforces apply_patch availability and canonical names across model/provider constraints", () => {
    ...
    const enabledConfig: UltraClawConfig = {
      tools: {
        exec: {
    ...
    const openAiTools = createUltraClawCodingTools({
    ...
    const anthropicTools = createUltraClawCodingTools({
      config: enabledConfig,
    ...
    const allowModelsConfig: UltraClawConfig = {
      tools: {
        exec: {
    ...
    const allowed = createUltraClawCodingTools({
    ...
    const denied = createUltraClawCodingTools({
      config: allowModelsConfig,
      modelProvider: "openai",
      modelId: "gpt-5-mini",
    });
    ...
    const oauthTools = createUltraClawCodingTools({
      modelProvider: "anthropic",
      modelAuthMode: "oauth",
    });
