...
export const DEFAULT_SANDBOX_IMAGE = "ultraclaw-sandbox:bookworm-slim";
export const DEFAULT_SANDBOX_CONTAINER_PREFIX = "ultraclaw-sbx-";
...
export const DEFAULT_SANDBOX_BROWSER_IMAGE = "ultraclaw-sandbox-browser:bookworm-slim";
export const DEFAULT_SANDBOX_COMMON_IMAGE = "ultraclaw-sandbox-common:bookworm-slim";
export const SANDBOX_BROWSER_SECURITY_HASH_EPOCH = "2026-02-28-no-sandbox-env";

export const DEFAULT_SANDBOX_BROWSER_PREFIX = "ultraclaw-sbx-browser-";
export const DEFAULT_SANDBOX_BROWSER_NETWORK = "ultraclaw-sandbox-browser";
