...
const CONTEXT_ENGINE_REGISTRY_STATE = Symbol.for("ultraclaw.contextEngineRegistryState");
 ...
 */
export async function resolveContextEngine(config?: UltraClawConfig): Promise<ContextEngine> {
