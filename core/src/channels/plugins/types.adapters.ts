...
export type ChannelConfigAdapter<ResolvedAccount> = {
  ...
  resolveAccount: (cfg: UltraClawConfig, accountId?: string | null) => ResolvedAccount;
  inspectAccount?: (cfg: UltraClawConfig, accountId?: string | null) => unknown;
  defaultAccountId?: (cfg: UltraClawConfig) => string;
  setAccountEnabled?: (params: {
    cfg: UltraClawConfig;
    accountId: string;
    enabled: boolean;
  }) => UltraClawConfig;
  deleteAccount?: (params: { cfg: UltraClawConfig; accountId: string }) => UltraClawConfig;
  isEnabled?: (account: ResolvedAccount, cfg: UltraClawConfig) => boolean;
  disabledReason?: (account: ResolvedAccount, cfg: UltraClawConfig) => string;
  isConfigured?: (account: ResolvedAccount, cfg: UltraClawConfig) => boolean | Promise<boolean>;
  unconfiguredReason?: (account: ResolvedAccount, cfg: UltraClawConfig) => string;
  describeAccount?: (account: ResolvedAccount, cfg: UltraClawConfig) => ChannelAccountSnapshot;
...
export type ChannelGatewayContext<ResolvedAccount = unknown> = {
   ...
   * @see {@link https://docs.ultraclaw.os/plugins/developing-plugins | Plugin SDK documentation}
   */
...
export type ChannelHeartbeatAdapter = {
  ...
  resolveRecipients?: (params: { cfg: UltraClawConfig; opts?: { to?: string; all?: boolean } }) => {
    recipients: string[];
    source: string;
  };
};
