...
import { discoverUltraClawPlugins } from "../../plugins/discovery.js";
import type { UltraClawPackageManifest } from "../../plugins/manifest.js";
...
type ExternalCatalogEntry = {
  ...
  version?: string;
  description?: string;
} & Partial<Record<ManifestKey, UltraClawPackageManifest>>;

const ENV_CATALOG_PATHS = ["ULTRACLAW_PLUGIN_CATALOG_PATHS", "ULTRACLAW_MPM_CATALOG_PATHS"];
...
function toChannelMeta(params: {
  channel: NonNullable<UltraClawPackageManifest["channel"]>;
  id: string;
}): ChannelMeta | null {
...
function resolveInstallInfo(params: {
  manifest: UltraClawPackageManifest;
  packageName?: string;
  packageDir?: string;
  workspaceDir?: string;
...
function buildCatalogEntry(candidate: {
  ...
  packageDir?: string;
  workspaceDir?: string;
  packageManifest?: UltraClawPackageManifest;
