...
export function createAccountListHelpers(
  ...
  function resolveConfiguredDefaultAccountId(cfg: UltraClawConfig): string | undefined {
  ...
  function listAccountIds(cfg: UltraClawConfig): string[] {
  ...
  function resolveDefaultAccountId(cfg: UltraClawConfig): string {
