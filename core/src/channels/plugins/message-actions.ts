...
export function listChannelMessageActions(cfg: UltraClawConfig): ChannelMessageActionName[] {
...
export function supportsChannelMessageButtons(cfg: UltraClawConfig): boolean {
...
export function supportsChannelMessageCards(cfg: UltraClawConfig): boolean {
