...
export type ChannelAgentToolFactory = (params: { cfg?: UltraClawConfig }) => ChannelAgentTool[];
...
export type ChannelAgentPromptAdapter = {
  messageToolHints?: (params: { cfg: UltraClawConfig; accountId?: string | null }) => string[];
};
...
export type ChannelMessageActionAdapter = {
   ...
   */
  listActions?: (params: { cfg: UltraClawConfig }) => ChannelMessageActionName[];
  supportsAction?: (params: { action: ChannelMessageActionName }) => boolean;
  supportsButtons?: (params: { cfg: UltraClawConfig }) => boolean;
  supportsCards?: (params: { cfg: UltraClawConfig }) => boolean;
