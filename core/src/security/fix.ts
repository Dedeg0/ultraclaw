...
function setGroupPolicyAllowlist(params: {
  ...
  const section = params.cfg.channels[params.channel as keyof UltraClawConfig["channels"]] as
...
function applyConfigFixes(params: { cfg: UltraClawConfig; env: NodeJS.ProcessEnv }): {
  cfg: UltraClawConfig;
  changes: string[];
  policyFlips: Set<string>;
} {
