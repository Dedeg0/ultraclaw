...
import { type UltraClawConfig, loadConfig } from "../config/config.js";
...
function listConfiguredAgentIds(cfg: UltraClawConfig): string[] {
...
export function listAgentsForGateway(cfg: UltraClawConfig): {
  defaultId: string;
  mainKey: string;
  scope: SessionScope;
...
function resolveDefaultStoreAgentId(cfg: UltraClawConfig): string {
...
function resolveSessionStoreAgentId(cfg: UltraClawConfig, canonicalKey: string): string {
...
export function loadCombinedSessionStoreForGateway(cfg: UltraClawConfig): {
  storePath: string;
  store: Record<string, SessionEntry>;
} {
  const storeConfig = cfg.session?.store;
...
export function getSessionDefaults(cfg: UltraClawConfig): GatewaySessionsDefaults {
