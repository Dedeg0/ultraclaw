...
export function hasAmbiguousGatewayAuthModeConfig(cfg: UltraClawConfig): boolean {
...
export function assertExplicitGatewayAuthModeWhenBothConfigured(cfg: UltraClawConfig): void {
