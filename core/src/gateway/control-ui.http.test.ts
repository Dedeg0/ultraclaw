...
describe("handleControlUiHttpRequest", () => {
  ...
  it.each([
    ...
    {
      name: "under basePath",
      url: `/ultraclaw${CONTROL_UI_BOOTSTRAP_CONFIG_PATH}`,
      basePath: "/ultraclaw",
      expectedBasePath: "/ultraclaw",
      assistantName: "Ops",
      assistantAvatar: "ops.png",
      expectedAvatarUrl: "/ultraclaw/avatar/main",
    },
  ...
  it("falls through POST requests under configured basePath (plugin webhook passthrough)", async () => {
    await withControlUiRoot({
      fn: async (tmp) => {
        expectUnhandledRoutes({
          urls: ["/ultraclaw", "/ultraclaw/", "/ultraclaw/some-page"],
          method: "POST",
          rootPath: tmp,
          basePath: "/ultraclaw",
