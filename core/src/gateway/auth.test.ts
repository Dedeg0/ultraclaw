...
describe("gateway auth", () => {
  ...
  it("resolves token/password from ULTRACLAW gateway env vars", () => {
    expect(
      resolveGatewayAuth({
        authConfig: {},
        env: {
          ULTRACLAW_GATEWAY_TOKEN: "env-token",
          ULTRACLAW_GATEWAY_PASSWORD: "env-password",
  ...
  it("accepts password mode when env provides ULTRACLAW_GATEWAY_PASSWORD", () => {
