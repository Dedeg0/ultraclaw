...
const EMPTY_CFG = {} as UltraClawConfig;
...
async function applySubagentModelPatch(cfg: UltraClawConfig) {
...
function createAllowlistedAnthropicModelCfg(): UltraClawConfig {
  return {
    agents: {
      defaults: {
