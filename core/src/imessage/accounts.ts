...
function mergeIMessageAccountConfig(cfg: UltraClawConfig, accountId: string): IMessageAccountConfig {
...
export function listEnabledIMessageAccounts(cfg: UltraClawConfig): ResolvedIMessageAccount[] {
