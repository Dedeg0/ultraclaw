...
export function isAcpEnabledByPolicy(cfg: UltraClawConfig): boolean {
  return cfg.acp?.enabled !== false;
}

export function resolveAcpDispatchPolicyState(cfg: UltraClawConfig): AcpDispatchPolicyState {
...
export function isAcpDispatchEnabledByPolicy(cfg: UltraClawConfig): boolean {
  return resolveAcpDispatchPolicyState(cfg) === "enabled";
}

export function resolveAcpDispatchPolicyMessage(cfg: UltraClawConfig): string | null {
...
export function resolveAcpDispatchPolicyError(cfg: UltraClawConfig): AcpRuntimeError | null {
...
export function isAcpAgentAllowedByPolicy(cfg: UltraClawConfig, agentId: string): boolean {
