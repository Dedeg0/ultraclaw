...
let originalUltraClawTestConsole: string | undefined;
...
beforeEach(() => {
  ...
  originalUltraClawTestConsole = process.env.ULTRACLAW_TEST_CONSOLE;
  process.env.ULTRACLAW_TEST_CONSOLE = "1";
...
afterEach(() => {
  ...
  if (originalUltraClawTestConsole === undefined) {
    delete process.env.ULTRACLAW_TEST_CONSOLE;
  } else {
    process.env.ULTRACLAW_TEST_CONSOLE = originalUltraClawTestConsole;
  }
