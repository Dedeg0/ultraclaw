...
function mergeSignalAccountConfig(cfg: UltraClawConfig, accountId: string): SignalAccountConfig {
...
export function listEnabledSignalAccounts(cfg: UltraClawConfig): ResolvedSignalAccount[] {
