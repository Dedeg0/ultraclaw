...
function resolveAnthropicDefaultAuthMode(cfg: UltraClawConfig): AnthropicAuthDefaultsMode | null {
...
export function applyMessageDefaults(cfg: UltraClawConfig): UltraClawConfig {
...
export function applyTalkApiKey(config: UltraClawConfig): UltraClawConfig {
...
export function applyTalkConfigNormalization(config: UltraClawConfig): UltraClawConfig {
  return normalizeTalkConfig(config);
}

export function applyModelDefaults(cfg: UltraClawConfig): UltraClawConfig {
  let mutated = false;
  let nextCfg = cfg;
...
export function applyAgentDefaults(cfg: UltraClawConfig): UltraClawConfig {
...
export function applyLoggingDefaults(cfg: UltraClawConfig): UltraClawConfig {
...
export function applyContextPruningDefaults(cfg: UltraClawConfig): UltraClawConfig {
...
export function applyCompactionDefaults(cfg: UltraClawConfig): UltraClawConfig {
  const defaults = cfg.agents?.defaults;
  if (!defaults) {
    return cfg;
  }
