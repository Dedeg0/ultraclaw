...
describe("launchctl list detection", () => {
  it("detects the resolved label in launchctl list", async () => {
    state.listOutput = "123 0 ai.ultraclaw.gateway\n";
    const listed = await isLaunchAgentListed({
      env: { HOME: "/Users/test", ULTRACLAW_PROFILE: "default" },
    });
...
describe("launchd bootstrap repair", () => {
  it("enables, bootstraps, and kickstarts the resolved label", async () => {
    ...
    const label = "ai.ultraclaw.gateway";
...
describe("launchd install", () => {
  ...
  it("shows actionable guidance when launchctl gui domain does not support bootstrap", async () => {
    ...
    expect(message).toContain("https://docs.ultraclaw.os/gateway");
  });
...
describe("resolveLaunchAgentPlistPath", () => {
  it.each([
    {
      name: "uses default label when ULTRACLAW_PROFILE is unset",
      env: { HOME: "/Users/test" },
      expected: "/Users/test/Library/LaunchAgents/ai.ultraclaw.gateway.plist",
    },
    {
      name: "uses profile-specific label when ULTRACLAW_PROFILE is set to a custom value",
      env: { HOME: "/Users/test", ULTRACLAW_PROFILE: "jbphoenix" },
      expected: "/Users/test/Library/LaunchAgents/ai.ultraclaw.jbphoenix.plist",
    },
    {
      name: "prefers ULTRACLAW_LAUNCHD_LABEL over ULTRACLAW_PROFILE",
      env: {
        HOME: "/Users/test",
        ULTRACLAW_PROFILE: "jbphoenix",
        ULTRACLAW_LAUNCHD_LABEL: "com.custom.label",
      },
      expected: "/Users/test/Library/LaunchAgents/com.custom.label.plist",
    },
    {
      name: "trims whitespace from ULTRACLAW_LAUNCHD_LABEL",
      env: {
        HOME: "/Users/test",
        ULTRACLAW_LAUNCHD_LABEL: "  com.custom.label  ",
      },
    ...
    {
      name: "ignores empty ULTRACLAW_LAUNCHD_LABEL and falls back to profile",
      env: {
        HOME: "/Users/test",
        ULTRACLAW_PROFILE: "myprofile",
        ULTRACLAW_LAUNCHD_LABEL: "   ",
      },
      expected: "/Users/test/Library/LaunchAgents/ai.ultraclaw.myprofile.plist",
    },
  ])("$name", ({ env, expected }) => {
