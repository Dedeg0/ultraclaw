    ...
    .addHelpText(
      ...
      () =>
        `\n${theme.heading("Examples:")}\n${formatHelpExamples([
          ["ultraclaw directory self --channel slack", "Show the connected account identity."],
          [
            'ultraclaw directory peers list --channel slack --query "alice"',
            "Search contact/user IDs by name.",
          ],
          ["ultraclaw directory groups list --channel discord", "List available groups/channels."],
          [
            "ultraclaw directory groups members --channel discord --group-id <id>",
            "List members for a specific group.",
          ],
        ])}\n\n${theme.muted("Docs:")} ${formatDocsLink(
          "/cli/directory",
          "docs.ultraclaw.os/cli/directory",
        )}\n`,
    )
    .action(() => {
