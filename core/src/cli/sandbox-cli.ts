...
const SANDBOX_EXAMPLES = {
  main: [
    ["ultraclaw sandbox list", "List all sandbox containers."],
    ["ultraclaw sandbox list --browser", "List only browser containers."],
    ["ultraclaw sandbox recreate --all", "Recreate all containers."],
    ["ultraclaw sandbox recreate --session main", "Recreate a specific session."],
    ["ultraclaw sandbox recreate --agent mybot", "Recreate agent containers."],
    ["ultraclaw sandbox explain", "Explain effective sandbox config."],
  ],
  list: [
    ["ultraclaw sandbox list", "List all sandbox containers."],
    ["ultraclaw sandbox list --browser", "List only browser containers."],
  ...
  recreate: [
    ["ultraclaw sandbox recreate --all", "Recreate all containers."],
    ["ultraclaw sandbox recreate --session main", "Recreate a specific session."],
    ["ultraclaw sandbox recreate --agent mybot", "Recreate a specific agent (includes sub-agents)."],
    ["ultraclaw sandbox recreate --browser --all", "Recreate only browser containers."],
    ["ultraclaw sandbox recreate --all --force", "Skip confirmation."],
  ],
  explain: [
    ["ultraclaw sandbox explain", "Show effective sandbox config."],
    ["ultraclaw sandbox explain --session agent:main:main", "Explain a specific session."],
    ["ultraclaw sandbox explain --agent work", "Explain an agent sandbox."],
    ["ultraclaw sandbox explain --json", "JSON output."],
  ],
} as const;
...
export function registerSandboxCli(program: Command) {
  const sandbox = program
    ...
    .addHelpText(
      "after",
      () =>
        `\n${theme.muted("Docs:")} ${formatDocsLink("/cli/sandbox", "docs.ultraclaw.os/cli/sandbox")}\n`,
    )
    .action(() => {
