    ...
    .addHelpText(
      ...
      () =>
        `\n${theme.heading("Examples:")}\n${formatHelpExamples([
          ["ultraclaw channels list", "List configured channels and auth profiles."],
          ["ultraclaw channels status --probe", "Run channel status checks and probes."],
          [
            "ultraclaw channels add --channel telegram --token <token>",
            "Add or update a channel account non-interactively.",
          ],
          ["ultraclaw channels login --channel whatsapp", "Link a WhatsApp Web account."],
        ])}\n\n${theme.muted("Docs:")} ${formatDocsLink(
          "/cli/channels",
          "docs.ultraclaw.os/cli/channels",
        )}\n`,
    );
