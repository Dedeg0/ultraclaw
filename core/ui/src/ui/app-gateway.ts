...
export function connectGateway(host: GatewayHost) {
  ...
  const client = new GatewayBrowserClient({
    ...
    clientName: "ultraclaw-control-ui",
    clientVersion,
    mode: "webchat",
    ...
    onHello: (hello) => {
      ...
      void loadAssistantIdentity(host as unknown as UltraClawApp);
      void loadAgents(host as unknown as UltraClawApp);
      void loadHealthState(host as unknown as UltraClawApp);
      void loadNodes(host as unknown as UltraClawApp, { quiet: true });
      void loadDevices(host as unknown as UltraClawApp, { quiet: true });
...
function handleTerminalChatEvent(
  ...
  if (runId && host.refreshSessionsAfterChat.has(runId)) {
    ...
    if (state === "final") {
      void loadSessions(host as unknown as UltraClawApp, {
  ...
  if (hadToolEvents && state === "final") {
    void loadChatHistory(host as unknown as UltraClawApp);
    return true;
  }
  return false;
}
...
function handleChatGatewayEvent(host: GatewayHost, payload: ChatEventPayload | undefined) {
  ...
  const state = handleChatEvent(host as unknown as UltraClawApp, payload);
