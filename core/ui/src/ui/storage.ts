const KEY = "ultraclaw.control.settings.v1";
const LEGACY_TOKEN_SESSION_KEY = "ultraclaw.control.token.v1";
const TOKEN_SESSION_KEY_PREFIX = "ultraclaw.control.token.v1:";
...
function deriveDefaultGatewayUrl(): { pageUrl: string; effectiveUrl: string } {
  ...
  const configured =
    ...
    typeof window.__ULTRACLAW_CONTROL_UI_BASE_PATH__ === "string" &&
    window.__ULTRACLAW_CONTROL_UI_BASE_PATH__.trim();
