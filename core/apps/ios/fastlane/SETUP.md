...
ASC_KEYCHAIN_SERVICE=ultraclaw-asc-key
...
```bash
ASC_APP_IDENTIFIER=ai.ultraclaw.client
# or
...
- The beta flow regenerates `apps/ios/UltraClaw.xcodeproj` from `apps/ios/project.yml` before archiving
