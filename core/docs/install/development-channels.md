...
UltraClaw ships three update channels:
...
When you **explicitly** switch channels with `--channel`, UltraClaw also aligns
the install method:
...
When you switch channels with `ultraclaw update`, UltraClaw also syncs plugin sources:
