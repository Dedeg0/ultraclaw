---
summary: "Use Synthetic's Anthropic-compatible API in UltraClaw"
read_when:
...
Synthetic exposes Anthropic-compatible endpoints. UltraClaw registers it as the
...
Note: UltraClaw's Anthropic client appends `/v1` to the base URL, so use
