---
summary: "Use Qianfan's unified API to access many models in UltraClaw"
read_when:
...
3. UltraClaw installed on your system
...
4. Copy the API key for use with UltraClaw

## CLI setup

```bash
ultraclaw onboard --auth-choice qianfan-api-key
```

## Related Documentation

- [UltraClaw Configuration](/gateway/configuration)
