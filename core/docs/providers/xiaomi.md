---
summary: "Use Xiaomi MiMo (mimo-v2-flash) with UltraClaw"
read_when:
  - You want Xiaomi MiMo models in UltraClaw
...
the [Xiaomi MiMo console](https://platform.xiaomimimo.com/#/console/api-keys). UltraClaw uses
