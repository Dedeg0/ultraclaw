...
You can point UltraClaw at the proxy as a custom OpenAI-compatible endpoint:
...
- This is a **community tool**, not officially supported by Anthropic or UltraClaw
...
- [Anthropic provider](/providers/anthropic) - Native UltraClaw integration with Claude setup-token or API keys
