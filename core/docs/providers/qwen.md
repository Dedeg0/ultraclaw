---
summary: "Use Qwen OAuth (free tier) in UltraClaw"
read_when:
  - You want to use Qwen with UltraClaw
...
If you already logged in with the Qwen Code CLI, UltraClaw will sync credentials
