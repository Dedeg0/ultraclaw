---
summary: "Use NVIDIA's OpenAI-compatible API in UltraClaw"
read_when:
  - You want to use NVIDIA models in UltraClaw
...
ultraclaw onboard --auth-choice skip
ultraclaw models set nvidia/nvidia/llama-3.1-nemotron-70b-instruct
```
