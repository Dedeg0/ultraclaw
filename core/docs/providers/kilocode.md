---
summary: "Use Kilo Gateway's unified API to access many models in UltraClaw"
read_when:
  - You want a single API key for many LLMs
  - You want to run models via Kilo Gateway in UltraClaw
---
...
```bash
ultraclaw onboard --kilocode-api-key <key>
```
...
UltraClaw dynamically discovers available models from the Kilo Gateway at startup. Use
