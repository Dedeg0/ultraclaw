...
ultraclaw system heartbeat last
ultraclaw logs --follow
ultraclaw config get agents.defaults.heartbeat
ultraclaw channels status --probe
```
...
```bash
ultraclaw config get agents.defaults.heartbeat.activeHours
ultraclaw config get agents.defaults.heartbeat.activeHours.timezone
ultraclaw config get agents.defaults.userTimezone || echo "agents.defaults.userTimezone not set"
ultraclaw cron list
ultraclaw logs --follow
```
