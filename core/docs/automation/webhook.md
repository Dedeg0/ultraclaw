...
read_when:
  ...
  - Wiring external systems into UltraClaw
title: "Webhooks"
---
...
- `hooks.transformsDir` + `transform.module` loads a JS/TS module for custom logic.
  - `hooks.transformsDir` (if set) must stay within the transforms root under your UltraClaw config directory (typically `~/.ultraclaw/hooks/transforms`).
...
- `ultraclaw webhooks gmail setup` writes `hooks.gmail` config for `ultraclaw webhooks gmail run`.
