...
- 生成的 Swift 模型：`apps/macos/Sources/UltraClawProtocol/GatewayModels.swift`
...
- https://raw.githubusercontent.com/ultraclaw/ultraclaw/main/dist/protocol.schema.json
