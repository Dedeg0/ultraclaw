---
summary: "Synology Chat webhook setup and UltraClaw config"
read_when:
  - Setting up Synology Chat with UltraClaw
...
```bash
ultraclaw plugins install ./extensions/synology-chat
```
...
3. Point the outgoing webhook URL to your UltraClaw gateway:
   - `https://gateway-host/webhook/synology` by default.
   - Or your custom `channels.synology-chat.webhookPath`.
4. Configure `channels.synology-chat` in UltraClaw.
...
- Pairing approvals work with:
  - `ultraclaw pairing list synology-chat`
  - `ultraclaw pairing approve synology-chat <CODE>`
...
```bash
ultraclaw message send --channel synology-chat --target 123456 --text "Hello from UltraClaw"
ultraclaw message send --channel synology-chat --target synology-chat:123456 --text "Hello again"
```
