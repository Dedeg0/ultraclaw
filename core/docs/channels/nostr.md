...
read_when:
  - You want UltraClaw to receive DMs via Nostr
...
Nostr is a decentralized protocol for social networking. This channel enables UltraClaw to receive and respond to encrypted direct messages (DMs) via NIP-04.

## Install (on demand)

### Onboarding (recommended)

- The onboarding wizard (`ultraclaw onboard`) and `ultraclaw channels add` list optional channel plugins.
...
```bash
ultraclaw plugins install @ultraclaw/nostr
```

Use a local checkout (dev workflows):

```bash
ultraclaw plugins install --link <path-to-ultraclaw>/extensions/nostr
```
...
```json
{
  "channels": {
    "nostr": {
      ...
      "profile": {
        "name": "ultraclaw",
        "displayName": "UltraClaw",
        "about": "Personal assistant DM bot",
        "picture": "https://example.com/avatar.png",
        "banner": "https://example.com/banner.png",
        "website": "https://example.com",
        "nip05": "ultraclaw@example.com",
        "lud16": "ultraclaw@example.com"
      }
    }
  }
}
