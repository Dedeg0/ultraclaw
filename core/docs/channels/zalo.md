...
- Install via CLI: `ultraclaw plugins install @ultraclaw/zalo`
...
1. Install the Zalo plugin:
   - From a source checkout: `ultraclaw plugins install ./extensions/zalo`
   - From npm (if published): `ultraclaw plugins install @ultraclaw/zalo`
...
- Approve via:
  - `ultraclaw pairing list zalo`
  - `ultraclaw pairing approve zalo <CODE>`
...
- Example: `ultraclaw message send --channel zalo --target 123456789 --message "hi"`.

## Troubleshooting

**Bot doesn't respond:**

- Check that the token is valid: `ultraclaw channels status --probe`
- Verify the sender is approved (pairing or allowFrom)
- Check gateway logs: `ultraclaw logs --follow`
