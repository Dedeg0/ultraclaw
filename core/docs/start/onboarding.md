---
summary: "First-run onboarding flow for UltraClaw (macOS app)"
read_when:
...
<Frame caption="Choose what permissions do you want to give UltraClaw">
...
<Step title="CLI">
  ...
  The app can install the global `ultraclaw` CLI via npm/pnpm so terminal
