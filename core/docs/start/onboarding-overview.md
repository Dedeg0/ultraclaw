---
summary: "Overview of UltraClaw onboarding options and flows"
read_when:
...
UltraClaw supports multiple onboarding paths depending on where the Gateway runs
...
- [`ultraclaw onboard` command](/cli/onboard)

## macOS app onboarding

Use the UltraClaw app when you want a fully guided setup on macOS. Docs:
