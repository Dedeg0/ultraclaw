...
read_when:
  - You are building a UltraClaw plugin
  - You need to ship a plugin config schema or debug plugin validation errors
title: "Plugin Manifest"
---

# Plugin manifest (ultraclaw.plugin.json)

Every plugin **must** ship a `ultraclaw.plugin.json` file in the **plugin root**.
UltraClaw uses this manifest to validate configuration **without executing plugin
