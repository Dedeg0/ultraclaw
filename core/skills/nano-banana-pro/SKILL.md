...
- Or set `skills."nano-banana-pro".apiKey` / `skills."nano-banana-pro".env.GEMINI_API_KEY` in `~/.ultraclaw/ultraclaw.json`
...
- The script prints a `MEDIA:` line for UltraClaw to auto-attach on supported chat providers.
